# nf-core/deepmodeloptim: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/deepmodeloptim/usage](https://nf-co.re/deepmodeloptim/usage)
...
```bash
nextflow run nf-core/deepmodeloptim -profile docker -params-file params.yaml
```
...
```bash
nextflow pull nf-core/deepmodeloptim
```
